...
export default async function CompanyDashboard() {
    ...
    try {
        ...
        const [profileRes, appsRes, internshipsRes] = await Promise.all([
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card className="glass shadow-sm">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">{avgMatchScore !== null ? `${avgMatchScore}%` : 'N/A'}</div>
                        <p className="text-xs text-muted-foreground mt-1 text-green-500 font-medium font-bold uppercase tracking-tighter">
                            {avgMatchScore !== null ? 'From recent applicants' : 'No applicants yet'}
                        </p>
                    </CardContent>
                </Card>
                <Card className="glass shadow-sm">
